...
updatePreferences = function ( idAgentToUpdate, idAgent2, influence)
...
getValueUtilityForProdukt = function( idAgent, idProduct )
	...
	local brPrefAgent = zrangeall(tostring(idAgent)..KEY_BRAND_PREFERENCES)
	local tAccordance = {}	
	local tImportance = {}
	local counter = 0
...
initialize = function()
	...
	for n = 1, NUMBER_ITERATIONS do
		...
		tabResult[n] = tostring(result).." "..(time_end[1]+time_end[2]/1000000)-(time_start[1]+time_start[2]/1000000)
	end	
	return tabResult
end
